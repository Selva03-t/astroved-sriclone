                                    ...
                                    <div className="flex-1 min-w-0">
                                      ...
                                      <div className="mt-3 flex flex-wrap items-center gap-2">
                                        <div className="bg-[#eef2ff] border border-[#6869F9]/10 rounded-lg px-2 py-0.5 flex flex-col justify-center">
                                          <span className="text-sm font-black text-[#6869F9]">{currencySymbol} {getDisplayPrice(pkg)}</span>
                                        </div>
            ...
            <div className="mx-auto flex max-w-[1300px] items-center justify-between gap-4">
              <div className="min-w-0">
                ...
                <div className="flex items-center gap-3">
                  <div className="flex flex-col justify-center">
                    <p className="text-lg font-black text-[#6869F9] leading-tight">{currencySymbol} {selectedPackage ? getDisplayPrice(selectedPackage) : "—"}</p>
                  </div>
                  {selectedPackage && (
                 ...
                 <div className="space-y-4">
                    ...
                    <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm relative">
                       <div className="flex justify-between items-start mb-4">
                          ...
                          <div className="bg-[#6869F9]/10 text-[#6869F9] px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider shrink-0">
                             Primary Package
                          </div>
                       </div>
