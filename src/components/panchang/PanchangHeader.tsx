...
export default function PanchangHeader({ data }: { data: any }) {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
      <div className="bg-orange-500 px-6 py-8 text-white relative overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            ...
            <div className="text-right">
              ...
              <div className="text-orange-100">{weekday}</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="flex border-b border-gray-100 px-4">
        <button className="px-6 py-4 text-orange-600 border-b-2 border-orange-600 font-medium">Today</button>
