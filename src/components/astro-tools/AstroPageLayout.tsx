...
// ─── Sidebar data ─────────────────────────────────────────────────────────────
const ARTICLES = [
  { title: "Hanuman Chalisa", updated: "November 17, 2025", img: "🕉️" },
  { title: "Sharad Purnima Quotes & Wishes", updated: "May 19, 2025", img: "🌕" },
  { title: "Chaitra Amavasya Fast Story", updated: "April 29, 2025", img: "🙏" },
];
    ...
    <div className="space-y-2">
      {items.map((item, i) => (
        <div key={i} className="bg-white rounded-2xl border border-gray-200 overflow-hidden">
          ...
          >
            <span className="text-[14px] font-semibold text-gray-800 pr-4">{item.q}</span>
          ...
          {open === i && (
            <div className="px-5 pb-4 text-[13.5px] text-gray-600 leading-relaxed border-t border-gray-100 pt-3">
              {item.a}
            </div>
          )}
        </div>
  ...
  return (
    <div className="min-h-screen bg-[#f5f5f5]">
      ...
      <div className="max-w-[1400px] mx-auto px-6 py-6">
        ...
        {/* SEO subtitle */}
        <p className="text-[13px] text-gray-500 mb-4 font-medium">{seoSubtitle}</p>
        ...
        >
          ...
          <div className="relative z-10 p-10 pb-12">
            <h1 className="text-[2.5rem] font-extrabold text-white leading-tight drop-shadow-lg">
              {heroTitle}
            </h1>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_340px] gap-7 items-start">
          ...
          <div className="flex flex-col gap-7">
            ...
            <div className="px-1">
              {seoSections.map((s, i) => (
                <div key={i} className={i > 0 ? "mt-7" : ""}>
                  <h2 className="text-[16px] font-bold text-gray-900 mb-2">{s.heading}</h2>
                  <p className="text-[14px] text-gray-600 leading-[1.9]">{s.body}</p>
                </div>
              ))}
            </div>
            ...
            <div className="px-1">
              <h2 className="text-[18px] font-bold text-gray-900 mb-4">FAQs</h2>
