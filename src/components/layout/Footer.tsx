...
export default function Footer() {
  return (
    <footer className="w-full bg-gradient-to-br from-[#1e3a8a] via-[#1E40AF] to-[#1A56DB] text-white">
      <div className="mx-auto max-w-7xl px-6 py-12">
        ...
        <div className="mt-16 border-t border-white/20 pt-8 flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div className="flex gap-4">
             <a href="#" className="h-12 w-36 bg-black rounded-lg flex items-center px-3 text-[10px] gap-3 border border-white/20 cursor-pointer hover:bg-white/5 transition-all">
...
function SocialIcon({ platform, href }: { platform: string; href: string }) {
  ...
  return (
    <a href={href} target="_blank" rel="noopener noreferrer" className="h-8 w-8 bg-white rounded-full flex items-center justify-center text-[#1A56DB] text-sm cursor-pointer hover:bg-gray-100 transition-all shadow-sm">
